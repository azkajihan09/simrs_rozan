                ...
                <div class="col-md-4">
                    ...
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <small class="text-muted d-block">ID Laboratorium</small>
                            ...
                            <?php if (!empty($detail->file_hasil)): ?>
                                <div>
                                    ...
                                    <a href="<?= base_url('uploads/lab/' . $detail->file_hasil) ?>" target="_blank">
                                        <?= $detail->file_hasil ?>
                                    </a>
                                </div>
                            <?php endif; ?>
                ...
                <div class="col-md-8">
                    ...
                    <div class="card shadow-lg border-0">
                        ...
                        <div class="card-header bg-gradient-primary">
                            ...
                            <h3 class="card-title text-white">Input Hasil Pemeriksaan</h3>
                            ...
                            <form method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea
                                        ...
                                        class="form-control"
                                        rows="8"
                                        placeholder="Tulis hasil pemeriksaan laboratorium di sini"><?= !empty($detail->hasil) ? $detail->hasil : '' ?></textarea>
